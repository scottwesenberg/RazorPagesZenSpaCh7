...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20231027184643_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 27, 14, 46, 43, 592, DateTimeKind.Local).AddTicks(4841),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2023, 10, 27, 14, 46, 43, 592, DateTimeKind.Local).AddTicks(4877),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 27, 14, 46, 43, 592, DateTimeKind.Local).AddTicks(4879),
                            ServicesID = 5
                        });
                });
